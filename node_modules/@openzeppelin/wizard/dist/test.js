...
async function testCompile(t, kind) {
    const generatedSourcesPath = path_1.default.join(hardhat_1.default.config.paths.sources, `generated`);
    await fs_1.promises.rm(generatedSourcesPath, { force: true, recursive: true });
    await (0, sources_1.writeGeneratedSources)(generatedSourcesPath, 'all', kind);
